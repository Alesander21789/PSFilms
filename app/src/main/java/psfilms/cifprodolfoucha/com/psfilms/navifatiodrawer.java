...
public class navifatiodrawer extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    TableLayout table;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_navifatiodrawer);
    ...
    private View.OnClickListener _OnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(navifatiodrawer.this, informacion.class);
            //EditText editText = (EditText) findViewById(R.id.editText);
            //String message = editText.getText().toString();
            // intent.putExtra(EXTRA_MESSAGE, message);
            startActivity(intent);
